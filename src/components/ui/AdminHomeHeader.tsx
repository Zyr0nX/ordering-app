...
const AdminHomeHeader: React.FC = () => {
  return (
    <div className="from-viparyasDarkBlue/80 to-viparyasTeal/80 relative flex items-center justify-center bg-gradient-to-r pb-24 pt-16 text-white md:pb-32 md:pt-8">
      <button
